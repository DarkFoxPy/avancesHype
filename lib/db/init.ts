...
export function initDatabase() {
  ...
  // Create schedule_days table for multi-day events
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_schedule_days_event ON schedule_days(event_id);
    CREATE INDEX IF NOT EXISTS idx_schedule_days_date ON schedule_days(day_date);
  `)

  // Create triggers for updating registrations count
  db.exec(`
